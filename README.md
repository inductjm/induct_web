[style.css](https://github.com/user-attachments/files/23346500/style.css)
/* ===========================================================
   INDUCT — Estilo Corporativo Industrial
   Fondo negro | Texto blanco | Acentos azul metalizado
   =========================================================== */
...
.btn {
  ...
  font-weight: 700;
  cursor: pointer;
  transition: transform 140ms ease, box-shadow 160ms;
  border: 2px solid transparent;
}
.btn-primary {
  background: linear-gradient(180deg, var(--accent), #005cd1);
  color: #fff;
...
.product-grid { grid-auto-rows: minmax(140px, auto); }
